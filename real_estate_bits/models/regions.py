...
class Regions(models.Model):
    ...
    # Campo computado del pais para determinar si se deben forzar ciudades
    country_enforce_cities = fields.Boolean(
        string="Forzar Ciudades",
        compute='_compute_country_enforce_cities',
        store=True,
        help="Indica si el pais requiere seleccion de ciudad"
    )
    ...
    def _compute_country_enforce_cities(self):
        """Calcula si el pais requiere seleccion obligatoria de ciudades."""
        for barrio in self:
            if barrio.country_id:
                # Obtener la configuracion del pais
                barrio.country_enforce_cities = barrio.country_id.enforce_cities if hasattr(barrio.country_id, 'enforce_cities') else False
            else:
                barrio.country_enforce_cities = False
